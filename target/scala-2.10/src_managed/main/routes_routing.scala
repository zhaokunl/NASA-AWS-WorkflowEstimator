...
// @LINE:22
private[this] lazy val controllers_Application_estimate28 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("estimator/2"))))
        

// @LINE:23
private[this] lazy val controllers_Application_estimate39 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("estimator/3"))))
        

// @LINE:24
private[this] lazy val controllers_Application_tutorial10 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("estimator/tutorial"))))
        

// @LINE:25
private[this] lazy val controllers_Application_login11 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("estimator/login"))))
        

// @LINE:26
private[this] lazy val controllers_Application_authenticate12 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("estimator/login"))))
        

// @LINE:27
private[this] lazy val controllers_Application_logout13 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("estimator/logout"))))
        

// @LINE:28
private[this] lazy val controllers_Application_accountSummary14 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("estimator/accountSummary"))))
        

// @LINE:31
private[this] lazy val controllers_NasaRegistrationController_registrationForm15 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("estimator/register"))))
        

// @LINE:32
private[this] lazy val controllers_NasaRegistrationController_submit16 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("estimator/register/publish"))))
        

// @LINE:33
private[this] lazy val controllers_NasaRegistrationController_updateForm17 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("estimator/updateUser"))))
        

// @LINE:34
private[this] lazy val controllers_NasaRegistrationController_update18 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("estimator/updateUser/update"))))
        

// @LINE:35
private[this] lazy val controllers_NasaRegistrationController_deleteForm19 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("estimator/deleteUser"))))
        

// @LINE:36
private[this] lazy val controllers_NasaRegistrationController_delete20 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("estimator/deleteUser/delete"))))
        

// @LINE:37
private[this] lazy val controllers_NasaRegistrationController_adminPage21 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("estimator/adminPage"))))
...
// @LINE:22
case controllers_Application_estimate28(params) => {
   call { 
...
// @LINE:23
case controllers_Application_estimate39(params) => {
   call { 
...
// @LINE:24
case controllers_Application_tutorial10(params) => {
   call { 
...
// @LINE:25
case controllers_Application_login11(params) => {
   call { 
...
// @LINE:26
case controllers_Application_authenticate12(params) => {
   call { 
...
// @LINE:28
case controllers_Application_accountSummary14(params) => {
...
// @LINE:31
case controllers_NasaRegistrationController_registrationForm15(params) => {
   call { 
...
// @LINE:32
case controllers_NasaRegistrationController_submit16(params) => {
   call { 
...
// @LINE:33
case controllers_NasaRegistrationController_updateForm17(params) => {
   call { 
...
// @LINE:34
case controllers_NasaRegistrationController_update18(params) => {
   call { 
...
// @LINE:35
case controllers_NasaRegistrationController_deleteForm19(params) => {
   call { 
...
// @LINE:36
case controllers_NasaRegistrationController_delete20(params) => {
   call { 
...
// @LINE:37
case controllers_NasaRegistrationController_adminPage21(params) => {
   call { 
